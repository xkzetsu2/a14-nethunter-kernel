...
ksymdeps_drivers/base/core.o := \
    $(wildcard include/ksym/root/device/register.h) \
    $(wildcard include/ksym/dev/alert.h) \
    $(wildcard include/ksym/dev/crit.h) \
    $(wildcard include/ksym/dev/emerg.h) \
    $(wildcard include/ksym/dev/err.h) \
    $(wildcard include/ksym/dev/info.h) \
    $(wildcard include/ksym/dev/notice.h) \
    $(wildcard include/ksym/dev/warn.h) \
    $(wildcard include/ksym/dev/driver/string.h) \
    $(wildcard include/ksym/dev/err/probe.h) \
    $(wildcard include/ksym/dev/printk.h) \
    $(wildcard include/ksym/dev/printk/emit.h) \
    $(wildcard include/ksym/dev/set/name.h) \
    $(wildcard include/ksym/dev/vprintk/emit.h) \
    $(wildcard include/ksym/device/add.h) \
    $(wildcard include/ksym/device/add/groups.h) \
    $(wildcard include/ksym/device/change/owner.h) \
    $(wildcard include/ksym/device/create.h) \
    $(wildcard include/ksym/device/create/bin/file.h) \
    $(wildcard include/ksym/device/create/file.h) \
    $(wildcard include/ksym/device/create/with/groups.h) \
    $(wildcard include/ksym/device/del.h) \
    $(wildcard include/ksym/device/destroy.h) \
    $(wildcard include/ksym/device/find/child.h) \
    $(wildcard include/ksym/device/find/child/by/name.h) \
    $(wildcard include/ksym/device/for/each/child.h) \
    $(wildcard include/ksym/device/for/each/child/reverse.h) \
    $(wildcard include/ksym/device/initialize.h) \
    $(wildcard include/ksym/device/link/add.h) \
    $(wildcard include/ksym/device/link/del.h) \
    $(wildcard include/ksym/device/link/remove.h) \
    $(wildcard include/ksym/device/link/wait/removal.h) \
    $(wildcard include/ksym/device/match/acpi/dev.h) \
    $(wildcard include/ksym/device/match/any.h) \
    $(wildcard include/ksym/device/match/devt.h) \
    $(wildcard include/ksym/device/match/fwnode.h) \
    $(wildcard include/ksym/device/match/name.h) \
    $(wildcard include/ksym/device/match/of/node.h) \
    $(wildcard include/ksym/device/move.h) \
    $(wildcard include/ksym/device/register.h) \
    $(wildcard include/ksym/device/remove/bin/file.h) \
    $(wildcard include/ksym/device/remove/file.h) \
    $(wildcard include/ksym/device/remove/file/self.h) \
    $(wildcard include/ksym/device/remove/groups.h) \
    $(wildcard include/ksym/device/rename.h) \
    $(wildcard include/ksym/device/set/node.h) \
    $(wildcard include/ksym/device/set/of/node/from/dev.h) \
    $(wildcard include/ksym/device/show/bool.h) \
    $(wildcard include/ksym/device/show/int.h) \
    $(wildcard include/ksym/device/show/ulong.h) \
    $(wildcard include/ksym/device/store/bool.h) \
    $(wildcard include/ksym/device/store/int.h) \
    $(wildcard include/ksym/device/store/ulong.h) \
    $(wildcard include/ksym/device/unregister.h) \
    $(wildcard include/ksym/devm/device/add/group.h) \
    $(wildcard include/ksym/devm/device/add/groups.h) \
    $(wildcard include/ksym/devm/device/remove/group.h) \
    $(wildcard include/ksym/devm/device/remove/groups.h) \
    $(wildcard include/ksym/get/device.h) \
    $(wildcard include/ksym/kill/device.h) \
    $(wildcard include/ksym/put/device.h) \
    $(wildcard include/ksym/root/device/unregister.h) \
    $(wildcard include/ksym/set/primary/fwnode.h) \
    $(wildcard include/ksym/set/secondary/fwnode.h) \

drivers/base/core.o: $(ksymdeps_drivers/base/core.o)
