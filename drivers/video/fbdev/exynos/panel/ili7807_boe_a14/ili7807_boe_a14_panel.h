...
static u8 A14_VCOM_TYPE_TEST_START[] = {
	0xFF,
	0x78, 0x07, 0x07,
};

static u8 A14_VCOM_TYPE_TEST_END[] = {
	0xFF,
	0x78, 0x07, 0x00,
};
#endif
...
static DEFINE_STATIC_PACKET(a14_vcom_type_test_start, DSI_PKT_TYPE_WR, A14_VCOM_TYPE_TEST_START, 0);
static DEFINE_STATIC_PACKET(a14_vcom_type_test_end, DSI_PKT_TYPE_WR, A14_VCOM_TYPE_TEST_END, 0);
#endif
...
static void *a14_vcom_type_test_cmdtbl[] = {
	&PKTINFO(a14_vcom_type_test_start),
	&ili7807_boe_restbl[RES_VCOM_TYPE],
	&PKTINFO(a14_vcom_type_test_end),
};
#endif
...
static struct seqinfo a14_seqtbl[MAX_PANEL_SEQ] = {
	...
	[PANEL_VCOM_TYPE_TEST_SEQ] = SEQINFO_INIT("vcom_type_test_seq", a14_vcom_type_test_cmdtbl),
#endif
};
