...
#define ILI7807_VCOM_TYPE_REG				0xA3
#define ILI7807_VCOM_TYPE_OFS				0
#define ILI7807_VCOM_TYPE_LEN				1
#endif
...
static u8 ILI7807_VCOM_TYPE[ILI7807_VCOM_TYPE_LEN];
#endif
...
static struct rdinfo ili7807_boe_rditbl[] = {
	...
	[READ_VCOM_TYPE] = RDINFO_INIT(vcom_type, DSI_PKT_TYPE_RD, ILI7807_VCOM_TYPE_REG, ILI7807_VCOM_TYPE_OFS, ILI7807_VCOM_TYPE_LEN),
#endif
};
...
static DEFINE_RESUI(vcom_type, &ili7807_boe_rditbl[READ_VCOM_TYPE], 0);
#endif
...
static struct resinfo ili7807_boe_restbl[] = {
	...
	[RES_VCOM_TYPE] = RESINFO_INIT(vcom_type, ILI7807_VCOM_TYPE, RESUI(vcom_type)),
#endif
};
