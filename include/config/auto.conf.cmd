deps_config := \
	...
	drivers/input/touchscreen/focaltech/ft8720/Kconfig \
	drivers/input/touchscreen/ilitek/ili9881x/Kconfig \
	...
	drivers/bts/Kconfig \
	drivers/gud/gud-s5e3830/Kconfig \
	...
	drivers/gpu/arm/bv_r51p0/Kconfig \
	...
	drivers/media/platform/exynos/camera-pp/pd_mgr/Kconfig \
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu -integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
...
ifneq "$(CC_VERSION_TEXT)" "clang version 22.1.6"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "llvm-nm"
include/config/auto.conf: FORCE
