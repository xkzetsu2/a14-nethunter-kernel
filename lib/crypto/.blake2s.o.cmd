...
ksymdeps_lib/crypto/blake2s.o := \
    $(wildcard include/ksym/blake2s/final.h) \
    $(wildcard include/ksym/blake2s/update.h) \

lib/crypto/blake2s.o: $(ksymdeps_lib/crypto/blake2s.o)
