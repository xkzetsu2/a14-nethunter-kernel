...
kernel/cfi.o: $(deps_kernel/cfi.o)

$(deps_kernel/cfi.o):

ksymdeps_kernel/cfi.o := \
    $(wildcard include/ksym/cfi/slowpath.h) \
    $(wildcard include/ksym/ubsan/handle/cfi/check/fail/abort.h) \

kernel/cfi.o: $(ksymdeps_kernel/cfi.o)
