...
ksymdeps_kernel/user.o := \
    $(wildcard include/ksym/find/user.h) \
    $(wildcard include/ksym/free/uid.h) \
    $(wildcard include/ksym/init/user/ns.h) \

kernel/user.o: $(ksymdeps_kernel/user.o)
